const translations = {
    ...
    de: {
        ...
        clase_grande_desc: "Perfekt für diejenigen, die gerne in einer Gruppe trainieren und sich gemeinsam verbessern.",
...
function loadLanguage(lang) {
    ...
    console.log("Cargando idioma:", lang); // Verificar cuántas veces se ejecuta
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Event listener para cambios en el idioma
